...
public class JobSpecification {
    ...
    public static Specification<Job> hasMinBudget(BigDecimal minBudget) {
        return (root, query, cb) -> minBudget == null ? null : cb.greaterThanOrEqualTo(root.get("budget"), minBudget);
    }

    public static Specification<Job> hasMaxBudget(BigDecimal maxBudget) {
        return (root, query, cb) -> maxBudget == null ? null : cb.lessThanOrEqualTo(root.get("budget"), maxBudget);
    }
