...
class GlobalExceptionHandlerTest {
    ...
    void doesNotExposeUnexpectedExceptionMessage() {
        var response = handler.handleGlobalException(new RuntimeException("database password"), request);
    ...
    void mapsAuthorizationAndStateErrors() {
        ...
        var conflict = handler.handleIllegalState(new IllegalStateException("Already started"), request);
